    ...
    <div className="max-w-xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="flex gap-2 justify-between">
        <button
          ...
          className="px-4 py-2 rounded-lg bg-white border border-slate-200 text-slate-700 disabled:opacity-40 disabled:cursor-not-allowed hover:bg-slate-50"
        >
          ← 上一張
        </button>
        <button
          ...
          className="px-4 py-2 rounded-lg bg-blue-600 text-white disabled:opacity-40 disabled:cursor-not-allowed hover:bg-blue-700"
        >
          下一張 →
        </button>
      </div>
      ...
      <div className="flex flex-wrap gap-3 items-center justify-between text-sm">
        <button
          ...
          className="px-3 py-1.5 rounded-md bg-white border border-slate-200 text-slate-700 hover:bg-slate-50"
        >
